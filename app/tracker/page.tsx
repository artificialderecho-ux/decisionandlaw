...
export default function TrackerPage() {
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-[120px]">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-white">AI Regulation Tracker</h1>
        <p className="text-gray-400 mb-8">
          Track and monitor AI regulations, policies, and legal developments across different jurisdictions.
        </p>
      
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-lg p-6 hover:border-[#D4AF37]/50 transition-colors">
            <h2 className="text-xl font-semibold mb-3 text-white">State Regulations</h2>
            <p className="text-gray-400 mb-4">View AI regulations by state</p>
            <a href="/tracker/state" className="text-[#D4AF37] hover:text-[#B8941F] transition-colors">
              View State Regulations →
            </a>
          </div>
          
          <div className="bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-lg p-6 hover:border-[#D4AF37]/50 transition-colors">
            <h2 className="text-xl font-semibold mb-3 text-white">ABA Opinions</h2>
            <p className="text-gray-400 mb-4">American Bar Association AI opinions</p>
            <a href="/tracker/aba-opinions" className="text-[#D4AF37] hover:text-[#B8941F] transition-colors">
              View ABA Opinions →
            </a>
          </div>
          
          <div className="bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-lg p-6 hover:border-[#D4AF37]/50 transition-colors">
            <h2 className="text-xl font-semibold mb-3 text-white">Federal AI Policy</h2>
            <p className="text-gray-400 mb-4">Federal AI policies and regulations</p>
            <a href="/tracker/federal-ai-policy" className="text-[#D4AF37] hover:text-[#B8941F] transition-colors">
              View Federal Policy →
            </a>
          </div>
          
          <div className="bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-lg p-6 hover:border-[#D4AF37]/50 transition-colors">
            <h2 className="text-xl font-semibold mb-3 text-white">Malpractice Cases</h2>
            <p className="text-gray-400 mb-4">AI-related malpractice case tracking</p>
            <a href="/tracker/malpractice-cases" className="text-[#D4AF37] hover:text-[#B8941F] transition-colors">
              View Cases →
            </a>
          </div>
        </div>
